...
public class Variable02 {
	public static void main(String[] args) { //main 메소드 중괄호영역 시작
		...
		//num5 = 20;
		//num6 = 30;
		System.out.println(num4); //num4를 10이라는 정수로 선언했으니 10 출력
		System.out.println(num5); //num5를 20이라는 정수로 선언했으니 20 출력
		System.out.println(num6); //num6를 30이라는 정수로 선언했으니 30 출력
