...
-- 자동차 브랜드 car_brand varchar(1000)
-- 출시 날짜 car_release_date date
-- 색상 car_colr varchar2(1000)
-- 가격 car_price number
 ...
 * 
 * 
 * PK_CAR 이름으로 PK제약조건을 CAR_NUMBER컬럼에 추가하여 테이블을 수정하겠다
 * 
 * */
SELECT * FROM TBL_CAR;
...
-- PK 제약조건 설정된 컬럼은 NULL을 허용하지 않는다
...
CREATE TABLE TBL_STUDENT(
	...
	CONSTRAINT FK_STUDNET FOREIGN KEY(SCHOOL_NUMBER) REFERENCE TBL_SCHOOL(SCHOOL_NUMBER)
);
