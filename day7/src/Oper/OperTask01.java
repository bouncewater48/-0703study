...
public class OperTask01 {
	public static void main(String[] args) {
		...
		age = sc.nextInt(27);
		high = sc.nextInt(182);
		System.out.println(age + " > " + high + " : " + (age > high));
		sc.close();
		*/
		
		//항상 로직구성과 sc.close() 잊지말기
		//1) 입력클래스 import
		//2) 정수형 변수 2개 선언
		//3) 입력 메시지 출력(숫자 2개를 입력(띄워쓰기로) : )
		...
		/*
		int num1, num2;
		System.out.println("숫자 2개를 띄워쓰기로 구분하여 입력하세요 : ");
		num1 = sc.nextInt();
		num2 = sc.nextInt();
		//여기까지가 로직구성
		...
		*/
		...
		//실수 관계연산자 사용
		double num3, num4;
		System.out.println("실수 2개를 띄워쓰기를 구분하여 입력하세요 : ");
		num3 = sc.nextDouble();
		num4 = sc.nextDouble();	
