...
--학번(Stu_id) 이름(stu_name) 전공(stu_major) 과목코드(stu_course_code) 과목명(stu_course_name) 주소(stu_address)
	INSERT INTO TBL_STU
--	VALUES(01, '아무개', '컴퓨터 공학', 'is101', '데이터베이스', '서울시 서초구, 11123');
--	VALUES(02, '홍길동', '컴퓨터 공학', 'iw482', '알고리즘','인천시 미추홀구, 55158');
--	VALUES(03, '김철수', '인문학', 'hs204', '철학','대전시 대전구, 98741');
--	VALUES(04, '짱구' , '사학', 'sw897', '보존과학','서울시 강남구, 67845');
	VALUES(05, '신형만', '법학', 'lf545', '행정법','제주시 서귀포구, 41869');
...
CREATE TABLE TBL_SUBJECT(
	...
	SUB_COURSE_NAME VARCHAR2(100)
);

	SELECT * FROM TBL_SUBJECT;
	
	ALTER TABLE TBL_SUBJECT
	ADD CONSTRAINT PK_SUBJECT PRIMARY KEY(SUB_COURSE_CODE, SUB_COURSE_NAME);
