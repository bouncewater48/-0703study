...
--	DEFUALT 'M'은 데이터가 들어오지 않으면 무조건 'M'이 기본값을 들어가게 해준다
...
INSERT INTO TBL_STUDENT(STU_NUMBER, STU_ID, STU_NAME, STU_MAJOR, STU_GENDER)
VALUES(2, 'SU', '철수', '컴퓨터공학과', 'W', 1);
INSERT INTO TBL_STUDENT
...
UPDATE TBL_STUDENT
SET STU_GENDER = 'M'
--SET STU_GENDER = 'Male' -- 1글자만 들어가게 설정했기에 4글자는 넣으려하면 오류 발생
