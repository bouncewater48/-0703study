...
//	         조건문(if~else if~else)
	  ...
	  public void loginTry(String inputId1, String inputPw1) {
		  	String inputId1 = "userid1";
		  	String inputPw1	 = "userpw1";	
		  	{
		  if (inputId1.equals(userid) && inputPw1.equals(userpw)) {
			  System.out.println("관리자님 환영합니다");
			  break;
		  }else {
			  System.out.println("아이디 혹은 비밀번호를 다시 확인하세요");
		  }System.out.printf("userid1","userpw1");
		  break;
	  } 
  }
	   ...
	   public static void main(String[] args) {
	      ...
	      System.out.println("\n===========7번===========");
//	      System.out.println(mt.equals(inputId1,InputPw1));
//	      System.out.println(mt.equals(userId,userPw));
